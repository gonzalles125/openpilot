...
CAR_INFO: Dict[str, Union[ToyotaCarInfo, List[ToyotaCarInfo]]] = {
  ...
  CAR.LEXUS_RX_TSS2: [
    ...
    'carFingerprint': 'TOYOTA RAV4 2022',
               'carFw': [{'address': 1792,
                          'brand': 'toyota',
                          'bus': 0,
                          'ecu': 'engine',
                          'fwVersion': b'\x0189663K015300\x00\x00\x00\x00',
                          'logging': False,
                         ...
                         {'address': 1968,
                          ...
                          'bus': 0,
                          'ecu': 'abs',
                          'fwVersion': b'\x01F1526K007500\x00\x00\x00\x00',
                          'logging': False,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'\x10\x01', b'\x10\x03', b'"\xf1\x81'],
                         ...
                         {'address': 1953,
                          ...
                          'bus': 0,
                          'ecu': 'eps',
                          'fwVersion': b'\x018965BK003200\x00\x00\x00\x00',
                          'logging': False,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'\x10\x01', b'\x10\x03', b'"\xf1\x81'],
                         ...
                         {'address': 1920,
                          ...
                          'bus': 0,
                          'ecu': 'srs',
                          'fwVersion': b'\x018917F5251000\x00\x00\x00\x00',
                          'logging': True,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'\x10\x01', b'\x10\x03', b'"\xf1\x81'],
                         ...
                         {'address': 1984,
                          ...
                          'fwVersion': b'\x03838005D47103\x00\x00\x00\x00838005D47203\x00\x00\x00\x00838005D47302\x00\x00\x00\x00',
                          'logging': True,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'\x10\x01', b'\x10\x03', b'"\xf1\x81'],
                          'responseAddress': 1992,
                          'subAddress': 0},
                         {'address': 1872,
                          'brand': 'toyota',
                          'bus': 0,
                          'ecu': 'fwdRadar',
                          'fwVersion': b'\x018821F0D05300\x00\x00\x00\x00',
                          'logging': False,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'\x10\x01', b'\x10\x03', b'"\xf1\x81'],
                         ...
                         {'address': 1872,
                          ...
                          'bus': 0,
                          'ecu': 'fwdCamera',
                          'fwVersion': b'\x028646F5205200\x00\x00\x00\x008646G5202200\x00\x00\x00\x00',
                          'logging': False,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'\x10\x01', b'\x10\x03', b'"\xf1\x81'],
                          'responseAddress': 1880,
                         ...
                         {'address': 1872,
                          ...
                          'bus': 0,
                          'ecu': 'telematics',
                          'fwVersion': b'\x03FDC41.48.16\x00\x00\x00\x00\x00FDC41.58.16\x00\x00\x00\x00\x00130.0.7000\x00\x00\x00\x00\x00\x00',
                          'logging': True,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'\x10\x01', b'\x10\x03', b'"\xf1\x81'],
                          'responseAddress': 1880,
                         ...
                         {'address': 1988,
                          ...
                          'bus': 1,
                          'ecu': 'fwdCamera',
                          'fwVersion': b'\xf1\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x84\x00\x00\x00\x00\x00'
                         ...
                         {'address': 1971,
                          ...
                          'bus': 0,
                          'ecu': 'hvac',
                          'fwVersion': b'\xf1\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x84\x10\x00\x00\x00\x00'
                                       b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
                          'logging': True,
                          'obdMultiplexing': True,
                          'request': [b'"\xf1\x00'],
